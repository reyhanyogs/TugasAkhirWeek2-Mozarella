...
void Demo::Update(double deltaTime) {
	...
	position1 -= (float(deltaTime * 0.001f));
}
...
void Demo::DrawStreet()
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(0, -.47, 0));
	model = glm::scale(model, glm::vec3(100, 0.1, 4));
...
void Demo::DrawBench()
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(0, 0.10, 3.40));
	model = glm::scale(model, glm::vec3(0.45, 0.15, 1.3));
	...
	for (int i = 0; i < 2; i++) {
		...
		glm::mat4 model2;
		model2 = glm::translate(model2, glm::vec3(0, -0.1, 3 + i * 0.75));
		model2 = glm::scale(model2, glm::vec3(0.45, 0.25, 0.15));
